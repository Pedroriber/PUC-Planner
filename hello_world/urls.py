...
urlpatterns = [
    ...
    # CRUD Tarefas
    path("tarefas/", core_views.task_list, name="task_list"),
    path("tarefas/nova/", core_views.task_create, name="task_create"),
    path("tarefas/<int:pk>/editar/", core_views.task_update, name="task_update"),
    path("tarefas/<int:pk>/deletar/", core_views.task_delete, name="task_delete"),
